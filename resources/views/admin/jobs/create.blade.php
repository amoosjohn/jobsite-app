    ...
    <!-- Main -->
        ...
        <div class="padding">
            ...
            <div class="tab-content p-3 mb-3 box">
                <h3><i class="fa fa-marker" style="font-size: 28px;"></i> Add Job</h3>
                <hr class="mb-4">
                ...
                <form action="{{ route("jobs.store") }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="company_name" name="company_name" class="form-control {{ $errors->has('company_name') ? 'is-invalid' : '' }}" value="{{ old('company_name') }}">
                    ...
                    <div>
                        <button class="btn btn-primary mt-3 content-update">Submit</button>
                    </div>
                </form>
